...
# V lekci jsme zmínili, že existují i jiné typy indexů, než jen číselný, který sám vyrobí pandas. 
# Například v kontextu souboru se zvířaty se nabízí hned několik sloupců, které bychom mohli využít jako index, které nejsou číselné.
...
# Vyhledej řádek indexovaný názvem "Outloň váhavý". 
# Namísto metody .iloc využij .loc.

# Rozsahy fungují podobně jako u číselných indexů. 
# Vyhledej záznamy mezi "Želva Smithova" a "Želva žlutočelá".
